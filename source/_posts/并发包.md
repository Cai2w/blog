...
![ConcurrentHashMap数据结构](https://img.cai2.wang/ConcurrentHashMap数据结构.png)
...
* transfer()：数据转移到新表中，完成扩容
  ...
  ![](https://img.cai2.wang/JUC-ConcurrentHashMap-LastRun机制.png)
...
* 缺点：Segments 数组默认大小为16，这个容量初始化指定后就不能改变了，并且不是懒惰初始化
  ...
  ![](https://img.cai2.wang/JUC-ConcurrentHashMap 1.7底层结构.png)
...
<img src="https://img.cai2.wang/JUC-CopyOnWriteArrayList弱一致性.png" style="zoom:80%;" />
...
![](https://img.cai2.wang/JUC-ConcurrentSkipListMap数据结构.png)
...
* findPredecessor()：寻找前置节点
  ...
  ![](https://img.cai2.wang/JUC-ConcurrentSkipListMap-Put流程.png)
...
* remove()
  ...
  ![](https://img.cai2.wang/JUC-ConcurrentSkipListMap-remove流程.png)
...
![](https://img.cai2.wang/JUC-ConcurrentLinkedQueue入队操作1.png)

![](https://img.cai2.wang/JUC-ConcurrentLinkedQueue入队操作2.png)

![](https://img.cai2.wang/JUC-ConcurrentLinkedQueue入队操作3.png)
...
![](https://img.cai2.wang/JUC-ConcurrentLinkedQueue出队操作1.png)

![](https://img.cai2.wang/JUC-ConcurrentLinkedQueue出队操作2.png)

![](https://img.cai2.wang/JUC-ConcurrentLinkedQueue出队操作3.png)
