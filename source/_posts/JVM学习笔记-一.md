...
sticky:
cover: http://img.cai2.wang/undraw_developer_activity_bv83.png
---
...
![](http://img.cai2.wang/20211003172846.png)
...
![](http://img.cai2.wang/20211003004321.png)

我们主要学习的是 HotSpot 版本的虚拟机。

### 学习路线

![](http://img.cai2.wang/20211110234226.png)
...
![](http://img.cai2.wang/20211003083245.png)
...
![](http://img.cai2.wang/20211003005633.png)
...
![](http://img.cai2.wang/20211003083648.png)
...
![](http://img.cai2.wang/20211003091103.png)
...
![](http://img.cai2.wang/20211003091601.png)
...
![](http://img.cai2.wang/20211003100533.png)
...
![](http://img.cai2.wang/20211003113021.png)

![](http://img.cai2.wang/20211003113034.png)
...
![](http://img.cai2.wang/20211003121254.png)

每条指令都会对应常量池表中一个地址，常量池表中的地址可能对应着一个类名、方法名、参数类型等信息。

![](http://img.cai2.wang/20211003121312.png)
...
![](http://img.cai2.wang/20211003170018.png)

因为 java 不能直接操作文件管理，需要切换到内核态，使用本地方法进行操作，然后读取磁盘文件，会在系统内存中创建一个缓冲区，将数据读到系统缓冲区， 然后在将系统缓冲区数据，复制到 java 堆内存中。缺点是数据存储了两份，在系统内存中有一份，java 堆中有一份，造成了不必要的复制。

**使用了 DirectBuffer 文件读取流程**

![](http://img.cai2.wang/20211003170052.png)
