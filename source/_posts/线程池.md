...
* 当一个节点入队：
  ...
  ![](https://img.cai2.wang/JUC-LinkedBlockingQueue入队流程.png)
...
* `h = head` → `first = h.next` 
  ...
  ![](https://img.cai2.wang/JUC-LinkedBlockingQueue出队流程1.png)

* `h.next = h` → `head = first`

  ![](https://img.cai2.wang/JUC-LinkedBlockingQueue出队流程2.png)
...
![](https://img.cai2.wang/JUC-线程池工作原理.png)
...
![](https://img.cai2.wang/JUC-newSingleThreadExecutor.png)
...
* 状态表示：
  ...
  ![](https://img.cai2.wang/JUC-线程池状态转换图.png)
