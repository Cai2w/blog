...
* Mark Word 结构：最后两位是**锁标志位**
  ...
  ![](https://img.cai2.wang/JUC-Monitor-MarkWord结构32位.png)

* 64 位虚拟机 Mark Word：

  ![](https://img.cai2.wang/JUC-Monitor-MarkWord结构64位.png)
...
![](https://img.cai2.wang/JUC-锁升级过程.png)
...
<img src="https://img.cai2.wang/JUC-Monitor-MarkWord结构64位.png" style="zoom: 67%;" />
...
* 创建锁记录（Lock Record）对象，每个线程的**栈帧**都会包含一个锁记录的结构，存储锁定对象的 Mark Word
  ...
  ![](https://img.cai2.wang/JUC-轻量级锁原理1.png)

* 让锁记录中 Object reference 指向锁住的对象，并尝试用 CAS 替换 Object 的 Mark Word，将 Mark Word 的值存入锁记录

* 如果 CAS 替换成功，对象头中存储了锁记录地址和状态 00（轻量级锁） ，表示由该线程给对象加锁
  ![](https://img.cai2.wang/JUC-轻量级锁原理2.png)
...
* 如果 CAS 失败，有两种情况：
  ...
  * 如果是线程自己执行了 synchronized 锁重入，就添加一条 Lock Record 作为重入的计数
  ...
  ![](https://img.cai2.wang/JUC-轻量级锁原理3.png)
...
* 当 Thread-1 进行轻量级加锁时，Thread-0 已经对该对象加了轻量级锁
  ...
  ![](https://img.cai2.wang/JUC-重量级锁原理1.png)

* Thread-1 加轻量级锁失败，进入锁膨胀流程：为 Object 对象申请 Monitor 锁，**通过 Object 对象头获取到持锁线程**，将 Monitor 的 Owner 置为 Thread-0，将 Object 的对象头指向重量级锁地址，然后自己进入 Monitor 的 EntryList BLOCKED

  ![](https://img.cai2.wang/JUC-重量级锁原理2.png)
...
* 自旋成功的情况：
      <img src="https://img.cai2.wang/JUC-自旋成功.png" style="zoom: 80%;" />

* 自旋失败的情况：

  <img src="https://img.cai2.wang/JUC-自旋失败.png" style="zoom:80%;" />
...
![](https://img.cai2.wang/JUC-park原理1.png)
...
* 先 unpark：
  ...
  ![](https://img.cai2.wang/JUC-park原理2.png)
...
![](https://img.cai2.wang/JUC-保护性暂停.png)
...
![](https://img.cai2.wang/JUC-保护性暂停多任务版.png)
...
![](https://img.cai2.wang/JUC-生产者消费者模式.png)
