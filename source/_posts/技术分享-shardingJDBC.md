...
categories:
- Java
cover: http://img.cai2.wang/undraw_social_grl_562b.png
---
...
这两个项目是共用一个数据库的。
![image.png](http://img.cai2.wang/1628230562442-7d7d4145-aa26-4926-b3b0-790ff85424aa.png)

### 多应用多数据库
随着项目的不断推进迭代，我们需要开发新的模块---**创意工坊**。
为了开发新的模块，我们需要创建新的数据库，为了不使数据库更加混乱，我们建了一个新库用来存放创意工坊的数据。这其实就是“分库”了。
![](http://img.cai2.wang/1628231267971-8d07ffea-fa59-426f-b328-6ca0dde36dc4.png)
单数据库的能够支撑的并发量是有限的，拆成多个库可以使服务间不用竞争，提升服务的性能。如果只拆分应用不拆分数据库，不能解决根本问题，整个系统也很容易达到瓶颈。

随着数据量的不断增大，读写分离也就在我们考虑的范畴了
![](http://img.cai2.wang/1628232370085-c7306f7b-3ac8-4699-91a8-24c928283575.png)
...
![](http://img.cai2.wang/1628234873268-199a5a9a-7299-4389-91df-65a8e03ce057.png)
...
**架构图:**
![](http://img.cai2.wang/1628217504904-11991f71-a655-4d7a-bcee-d26381f43336.png)
...
![](http://img.cai2.wang/1628240013898-b1562474-5ed0-4bac-8608-28339eede028.png)
...
![](http://img.cai2.wang/1628244779856-5f8ae134-12b8-439a-a00d-3c9fe68f4e60.png)
...
![](http://img.cai2.wang/1628245983280-a71697fc-a67b-4e94-ac36-ec63d15e4ffa.png)

- 在从实例中查看数据库，发现也有一个`mall`数据库，可以判断主从复制已经搭建成功。

![](http://img.cai2.wang/1628246021302-5c0a86fc-ff64-4bb0-a2ea-8294b7847a5c.png)
## 读写分离
...
![](http://img.cai2.wang/1628246313014-65f85aaf-26f3-47b4-910d-53bd7b269f2f.png)
**优点：**
...
![](http://img.cai2.wang/1628246393683-97daf9e0-3b93-4c58-8cef-0f7314234543.png)
**优点：**
...
![](http://img.cai2.wang/1628246430164-0a4ab21b-1990-4798-87e4-d6f66651b8c8.png)
...
![](http://img.cai2.wang/20210812145324.png)
编写实体类接口：
...
插入数据**masterT()**：
![](http://img.cai2.wang/20210812220118.png)
查询数据**queryTest()**：
![](http://img.cai2.wang/image-20210812220324746.png)
成功
...
![](http://img.cai2.wang/20210812233553.png)
