...
description:
sticky:
cover: https://img.cai2.wang/undraw_miro_qvwm.png
---
...
![](https://img.cai2.wang/20211128142143.png)
...
1. **下载安装最新版的gcc编译器**
   ...
   - 查看是否安装gcc：`gcc --version`
     ...
     ![](https://img.cai2.wang/20211128150331.png)
...
2. **tar包上传到linux系统上并解压**
   ...
   ![](https://img.cai2.wang/20211128142515.png)
...
6. **跳过make test 继续执行: make install**
   ...
   ![](https://img.cai2.wang/20211128143714.png)

## 安装目录：`/usr/local/bin`

查看默认安装目录：

![](https://img.cai2.wang/20211128143851.png)
...
![](https://img.cai2.wang/20211128144149.png)
...
2. **后台启动设置`daemonize no`改成`yes`**
   ...
   ![](https://img.cai2.wang/20211128145044.png)
...
3. **Redis启动**
   ...
   ![](https://img.cai2.wang/20211128145331.png)
...
4. **用客户端访问**
   ...
   ![](https://img.cai2.wang/20211128145436.png)

5. **测试验证：ping**

   ![](https://img.cai2.wang/20211128145541.png)

6. **Redis关闭**

   1. **单实例关闭**：`redis-cli shutdown`

      ![](https://img.cai2.wang/20211128150154.png)

      也可以进入终端后再关闭

      ![](https://img.cai2.wang/20211128150021.png)
